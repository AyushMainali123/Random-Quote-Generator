...
const randomQuote = document.querySelector('[data-container] [data-random-quote]');
const authorSelector = document.querySelector('[data-container] [data-quote-author]');
const buttonSelector = document.querySelector('button');

let randomQuoteIndex = Math.floor(Math.random()*randomQuotes.length);
    randomQuote.textContent = randomQuotes[randomQuoteIndex].quote;
    authorSelector.textContent = randomQuotes[randomQuoteIndex].author;
